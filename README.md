...
Wang YJ, Chen BS, Lin MW, Lin AA, Peng H, Sung RJ, Wu SN. Time-dependent block of ultrarapid-delayed rectifier K(+) currents by aconitine, a potent cardiotoxin in heart-derived H9c2 myoblasts and in neonatal rat ventricular myocytes. *Toxicol Sci* (2008) 106:454-463.
...
`xpp ode\RatAPtest01.ode`
or
`xpp RatAPtest01.ode`

Mouse click on Initialconds, and then (G)o.

This makes a trace similar to the upper part of fig 6A, 6C and 7 in the paper of Wang et al.

![Rat AP](./RatAP.JPG)

This trace was used as a template of rat ventricular myocyte and replayed to H9c2 myoblasts in an attempt to evoke I(Kur).
